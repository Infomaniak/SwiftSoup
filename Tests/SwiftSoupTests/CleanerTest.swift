...
class CleanerTest: XCTestCase {
    ...
    func testHandlesCustomProtocols() throws {
        ...
        XCTAssertEqual("<img src=\"cid:12345\" /> <img src=\"data:gzzt\" />", preserved)
    }
    ...
    func testResolvesRelativeLinks() throws {
        ...
        XCTAssertEqual("<a href=\"http://example.com/foo\" rel=\"nofollow\">Link</a><img src=\"http://example.com/bar\" />", clean)
    }
    ...
    func testOnlyResolvesSlashPrefixedURLAttributes() throws {
        ...
        XCTAssertEqual("<a href=\"article.html\" rel=\"nofollow\">Link</a><img src=\"image.png\" />", clean)
    }
    ...
    func testPreservesRelativeLinksIfConfigured() throws {
        ...
        XCTAssertEqual("<a href=\"/foo\" rel=\"nofollow\">Link</a><img src=\"/bar\" /> <img />", clean)
    }
